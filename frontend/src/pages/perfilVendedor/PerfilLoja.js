        ...
        const fetchStoreData = async () => {
            try {
                ...
                if (err.response && err.response.data && err.response.data.error) {
                    ...
                    setError('Erro ao buscar dados da loja. Verifique os dados e tente novamente.');
                }
                    ...
                    <Col xs={12} md={6} lg={3} className="mb-4">
                        <Card className="h-100">
                            <Card.Body>
                                ...
                                <Link to="/PedidosPendentesLoja" className="btn btn-warning w-100">Ver Meus Pedidos</Link>
                            </Card.Body>
                        </Card>
                    </Col>
                    <Col xs={12} md={6} lg={3} className="mb-4">
                        <Card className="h-100">
                            <Card.Body>
                                ...
                                <Link to="/PedidosFinalizadosLoja" className="btn btn-info w-100">Ver Vendas Finalizadas</Link>
                            </Card.Body>
                        </Card>
                    </Col>
